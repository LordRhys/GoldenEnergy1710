...
public class GoldenWorldGenLakes extends WorldGenerator
{
	private Block blockName;	
	public GoldenWorldGenLakes(Block par1)
    {
        this.blockName = par1;
    }
        ...
        else
        {
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 0; i2 < 8; ++i2)
                    {
                        flag = !aboolean[(i1 * 16 + j2) * 8 + i2] && (i1 < 15 && aboolean[((i1 + 1) * 16 + j2) * 8 + i2] || 
                        		i1 > 0 && aboolean[((i1 - 1) * 16 + j2) * 8 + i2] || j2 < 15 && aboolean[(i1 * 16 + j2 + 1) * 8 + i2] || 
                        		j2 > 0 && aboolean[(i1 * 16 + (j2 - 1)) * 8 + i2] || i2 < 7 && aboolean[(i1 * 16 + j2) * 8 + i2 + 1] || 
                        		i2 > 0 && aboolean[(i1 * 16 + j2) * 8 + (i2 - 1)]);
                        ...
                        if (flag)
                        {
                            ...
                            if (i2 < 4 && !material.isSolid() && par1World.getBlock(par3 + i1, par4 + i2, par5 + j2) != this.blockName)
                            {
                                return false;
                            }
                        }
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 0; i2 < 8; ++i2)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + i2, par5 + j2, (Block) (i2 >= 4 ? Blocks.air : this.blockName), 0, 2);
                        }
                    }
                }
            }
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (i2 = 4; i2 < 8; ++i2)
                    {
                        if (aboolean[(i1 * 16 + j2) * 8 + i2] && (par1World.getBlock(par3 + i1, par4 + i2 - 1, par5 + j2) == 
                        		LordRhysModMain.goldenDirt || par1World.getBlock(par3 + i1, par4 + i2 - 1, par5 + j2) == 
                        		Blocks.dirt) && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + i1, par4 + i2, par5 + j2) > 0)
                        {
                            BiomeGenBase biomegenbase = par1World.getBiomeGenForCoords(par3 + i1, par5 + j2);

                            if (biomegenbase.topBlock == Blocks.mycelium)
                            {
                                par1World.setBlock(par3 + i1, par4 + i2 - 1, par5 + j2, Blocks.mycelium, 0, 2);
                            }
                            else if (biomegenbase.topBlock == LordRhysModMain.goldenGrass)
                            {
                                par1World.setBlock(par3 + i1, par4 + i2 - 1, par5 + j2, LordRhysModMain.goldenGrass, 0, 2);
                            }
                            else
                            {
                                par1World.setBlock(par3 + i1, par4 + i2 - 1, par5 + j2, Blocks.grass, 0, 2);
                            }
                        }
                    }
                }
            ...
            if (this.blockName.getMaterial() == Material.lava)
            {
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
            ...
            if (this.blockName.getMaterial() == Material.water)
            {
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
