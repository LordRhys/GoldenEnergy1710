...
public class BlockSlabVoidPowder extends BlockSlab
{
	private Block extendedBlock;
	
	public BlockSlabVoidPowder(boolean fullBlock,Block block, Material material) 
	{
	...
	{
		return Item.getItemFromBlock(LordRhysModMain.voidPowderHalfSlab);
	}
