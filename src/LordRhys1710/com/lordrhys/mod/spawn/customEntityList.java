package com.lordrhys.mod.spawn;
...
public class customEntityList
{
    ...
    public static Entity createEntityFromNBT(NBTTagCompound par0NBTTagCompound, World par1World)
    {
        ...
        if (entity != null)
        {
            ...
            {
                e.printStackTrace();
            	//FMLLog.log(Level.SEVERE, e, "An Entity " + par0NBTTagCompound.getString("id") +"(%s) has thrown an exception during loading, its state cannot be restored. Report this to the mod author", oclass.getName());
                entity = null;
            }
        }
        else
    ...
    static
    {
        ...
        addMapping(EntityReddyFreddy.class, "ReddyFreddy", 301, 0x3c578b,0xFFD338);        
    }
}
